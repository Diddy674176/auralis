...
export async function loadSettings(): Promise<AppSettings> {
  ...
  return {
    ...
    prepareMode: rest.prepareMode ?? DEFAULT_SETTINGS.prepareMode,
    batterySaver: rest.batterySaver ?? DEFAULT_SETTINGS.batterySaver,
    showBufferStatus: rest.showBufferStatus ?? DEFAULT_SETTINGS.showBufferStatus,
